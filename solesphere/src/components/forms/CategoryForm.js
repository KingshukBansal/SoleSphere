    ...
    return (
            ...
            <form onSubmit={handleSubmit} className='w-full flex flex-row'>
                <div className="mb-3 w-full">
                    <input type="text" class="rounded-xl p-3 outline-blue-700 w-full" onChange={(e)=>{setValue(e.target.value)}} placeholder="Enter the new Category" value={value} style={{ border: 'solid black 1px' }} />
                </div>
