...
const UpdateProductForm = ({ handleUpdate, product, setProduct,handleDelete }) => {
    ...
    return (
        <>
            ...
            <div className="mb-3">
                ...
                <button type="submit" className="btn btn-danger btn-lg ms-2" onClick={handleDelete}>Delete</button>
